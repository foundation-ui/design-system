...
import { QuickActionsMenu } from "./components/layouts/Menus";
import {
  ExternalLinksNavigation,
  InternalActionsNavigation,
} from "./components/layouts/Navigations";
...
const Heading = () => {
  return (
    <hgroup className="grid g-medium-60" style={{ maxWidth: 1024 }}>
      ...
      <p className="fs-medium-40 opacity-default-60" style={{ maxWidth: 768 }}>
        Foundation offers a suite of powerful Engines and Libraries, optimized
        to create cohesive UIs with agnostic Design Tokens and Themes. It
        provides accessible, robust, and intuitive components alongside User
        Behavior Analytics that can be programmatically integrated, ensuring
        seamless, data-driven design and development.
      </p>
        ...
        <DemoContainer>
          ...
          <Page.Menu className="flex justify-between align-center">
            ...
            <div className="flex g-medium-30 align-center">
              ...
              <Button variant="mono">Code</Button>
              <Button variant="mono">Share</Button>
              <Sheet.Trigger sizing="medium" variant="mono">
          ...
          <section
            className="grid g-medium-60 p-x-medium-30 p-y-medium-80"
            style={{ aspectRatio: 2 }}
          >
            <div className="flex justify-between g-medium-30">
              <h2>Analytics</h2>
      ...
      <Dialog.Root>
        <Page>
          <Page.Content>
            <Navbar />
            <section
              className="p-x-medium-60 p-b-medium-60 p-t-large-90 grid g-medium-90 align-center"
