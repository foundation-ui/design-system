...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex align-center g-medium-60">
        <Button variant="ghost" sizing="small">
          <svg viewBox="0 0 438.549 438.549" width={12} height={12}>
            <path
              fill="currentColor"
...
const Hero = () => {
  return (
    <section
      className="p-y-large-30 p-x-medium-60 grid g-large-30"
      style={{ maxWidth: 1440, margin: "0 auto" }}
    >
      <hgroup
        className="m-t-large-40 grid g-medium-60"
        style={{ maxWidth: 768 }}
      >
        <h1>
          Simple and powerful, Foundation UI is a Design System Toolkit that
          helps you to build, enhance and maintain applications
        </h1>

        <div className="flex  g-medium-30 align-center">
          <Button variant="primary">Start building for free</Button>
          <Button variant="border">Examples</Button>
        </div>
      </hgroup>
    </section>
  );
      ...
      <Page>
        <Page.Content>
          ...
          >
            {/** Item */}
            <div className="flex">
              <div className="p-medium-60" style={{ minWidth: 372 }}>
                box left
              </div>
