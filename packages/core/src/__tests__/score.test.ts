...
describe("getContrastRatio", () => {
  test("Returns the contrast ratio of a color based on its value of the background value", () => {
...
describe("calculateContrastScore", () => {
  test("Return the contrast score as a notation going from F(low) to AAA(high)", () => {
...
describe("calculateStackOrder", () => {
  test("Returns the hierarchy of a Design Token based on its context", () => {
...
describe("getSequenceUsages", () => {
  test("Returns the prefered usage of a Design Token based on its context", () => {
    // Depth
    expect(
