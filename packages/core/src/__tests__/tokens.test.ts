...
describe("generateColorTokens", () => {
  test("Generate a color Design token definition with variations", () => {
    expect(
  ...
  test("Generate a color Design token definition without variations", () => {
    expect(
      generateColorTokens("black", "212121", {
        alpha: false,
        tint: false,
  ...
  test("Returns undefined if the hex code provided is invalid", () => {
    expect(
...
describe("generateMeasurementTokens", () => {
  test("Generate a measurement Design token definition with variations", () => {
    expect(
  ...
  test("Generate a fontsize Design token definition with variations", () => {
...
describe("generateSequenceVariation", () => {
  test("Generate the variations values for an opacity sequence design token", () => {
    expect(
      generateSequenceVariation({
        contrast: 0.1,
      })
  ...
  test("Generate the variations values for a z-index sequence design token", () => {
    expect(
      generateSequenceVariation({
...
describe("generateSequenceTokens", () => {
  test("Generate a depth Design token definition with variations", () => {
  ...
  test("Generate an opacity Design token definition with variations", () => {
...
describe("generateTokensFromTemplate", () => {
  test("Generate a color design tokens set based on a standard payload", () => {
    expect(
      generateTokensFromTemplate({
        type: "color",
        values: [
  ...
  test("Generate a measurement design tokens set based on a standard payload", () => {
    expect(
      generateTokensFromTemplate({
        type: "fontsize",
        values: [
  ...
  test("Generate a sequence design tokens set based on a standard payload", () => {
    expect(
      generateTokensFromTemplate({
        type: "depth",
        values: [
...
describe("generateTokensLibrary", () => {
  test("Generate a design tokens library based on a standard payload", () => {
    const payload = [
      {
        type: "color",
        values: [
  ...
  test("Returns undefined if the token type is missing in a definition", () => {
    const payload = [
      {
        type: null,
        values: [
    ...
    expect(generateTokensLibrary("test", payload as any)).toEqual({
      design_tokens: {
        color: [],
        depth: [],
        fontsize: [],
