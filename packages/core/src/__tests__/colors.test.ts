...
describe("applyColorLuminance", () => {
  test("Increase the luminosity of a color and returns it as an hexidecimal color code", () => {
    const color = applyColorLuminance("#6f2a2a", 0.5); // 50% brighter
    expect(color).toEqual("#a73f3f");
  });
  test("Returns undefined if an invalid hexidecimal color code is provided", () => {
    const invalidColor = applyColorLuminance("#FAFA", 0.5);
    expect(invalidColor).toEqual(undefined);
  });
});
describe("setLuminanceTone", () => {
  test("Returns the input tone as is, or its negative value", () => {
...
describe("luminanceAmountFormatter", () => {
  test("Returns the opacity for a given color as a normalized value going from 0 to 1", () => {
...
describe("getRelativeLuminance", () => {
  test("Returns the luminosity of an RGB color as a normalized value going from 0(lowest luminosity) to 1(highest luminosity)", () => {
...
describe("generateAlpha", () => {
  test("Returns a set of alpha values for color design tokens", () => {
...
describe("generateVariation", () => {
  test("Returns a set of shade and tint variations for a color design token", () => {
