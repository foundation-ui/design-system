...
describe("Accordion", () => {
        ...
        <SystemThemeProvider>
          <Accordion.Root>
            <Accordion>
              ...
              <Accordion.Content value="1">2</Accordion.Content>
            </Accordion>
          </Accordion.Root>
        </SystemThemeProvider>
      </SystemThemeProvider>
  ...
  it("Renders as Default with accessibility definition", () => {
    render(
      <SystemThemeProvider>
        <Accordion.Root>
          <Accordion>
    ...
    // expect(AccordionTriggerComponent).toHaveAttribute("value", "1");
    // expect(AccordionTriggerComponent).toHaveAttribute("aria-expanded", "false");
  });
  it("Fires the defined callback when its clicked", async () => {
